        ...
        <div className={styles.projectsList}>
            <div className={styles.projectsFilter}>
                <div className={styles.typeSelect}>
                    <span style={{color: typeFilter === 'Web' ? 'yellow' : 'white', transition: "color 0.3s ease"}} 
                            onClick={ () => {handleClick(0, "type")}}>Web Development</span>
                    <span> - </span>
                    <span style={{color: typeFilter === 'Backend' ? 'yellow' : 'white', transition: "color 0.3s ease"}}
                            onClick={() => {handleClick(1, "type")}}>Backend Engineering</span>
                    <span> - </span>
                    <span style={{color: typeFilter === 'ML' ? 'yellow' : 'white', transition: "color 0.3s ease"}} 
                            onClick={() => {handleClick(2, "type")}}> Machine Learning</span>
                </div>
                <div className={styles.completeSelect}>
                    <span onClick={() => {handleClick(0, 'complete')}}
                            style={{color: completeFilter === 'Complete' ? 'yellow' : 'white'}}>
                        Completed</span>
                    <span> - </span>
                    <span onClick={() => {handleClick(1, 'complete')}}
